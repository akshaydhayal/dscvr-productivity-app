...
//     <main
//       className={`${
//         theme === "light" ? "bg-bg-desktop-light bg-white" : "bg-bg-desktop-dark w-full bg-gray-900"
//       } min-h-screen bg-no-repeat  flex justify-center`}
//     >
//       {/* <div className="flex flex-col w-full sm:w-2/3 md:w-3/4 lg:w-4/5 xl:w-1/2 p-10 sm:p-20"> */}
//       <div className="flex flex-col w-full p-10 sm:p-20">
//         <a
//           href="https://markrosario.vercel.app/"
//           target="_blank"
//           className={`${theme === "light" ? "text-black" : "text-white"} text-sm absolute bottom-0 right-0 p-2`}
//         >
...
//           <div className={`${theme === "light" ? "text-slate-800" : "text-slate-100"} tracking-[0.4em] text-4xl text-white font-bold`}>TODO</div>
...
//         <div
//           className={`${
//             theme === "light" ? "bg-white shadow-gray-400" : "bg-gray-800 shadow-gray-900"
//           } flex mt-5 gap-3 justify-center rounded-md shadow-sm py-4 px-5 visible sm:hidden`}
//         >
//           {["All", "Active", "Completed"].map((text, i) =>
//             theme === "light" ? (
//               <button
...
//           )}
//         </div>
//         <div className={`${theme === "light" ? "text-gray-400" : "text-gray-500"} text-center text-sm py-10`}>Drag and drop to reorder list</div>
//       </div>
//     </main>
//   );
// }
...
export default function TodoApp() {
  ...
  return (
    <main className={`bg-bg-desktop-dark w-full bg-gray-900 min-h-screen bg-no-repeat  flex justify-center`}>
      {/* <div className="flex flex-col w-full sm:w-2/3 md:w-3/4 lg:w-4/5 xl:w-1/2 p-10 sm:p-20"> */}
      <div className="flex flex-col w-full p-10 sm:p-20">
        ...
        {/* INPUT */}
        <div className={`bg-gray-800 flex text-lg rounded-md mt-12 py-4 px-5 items-center gap-5`}>
          <div className={`border-gray-600 rounded-full border-[1px] w-6 h-6 shrink-0`}></div>
          <input
            type="text"
            name="todo"
            id="todo"
        ...
        <div className={`bg-gray-800 shadow-gray-900 flex-col mt-5 rounded-md text-lg shadow-sm `}>
          ...
          {/* Status Bar */}
          <div className={`text-gray-500 flex justify-between items-center rounded-b-md text-xs py-3 px-5 `}>
            <div className="font-semibold w-1/3 text-left">{tasks.filter((task) => task.state === "Active").length} items left</div>
            <div className="hidden sm:flex gap-3 font-bold w-1/3 text-center ">
              {["All", "Active", "Completed"].map((text, i) =>
                theme === "light" ? (
        ...
        {/* MOBILE FILTER */}
        <div className={`bg-gray-800 shadow-gray-900 flex mt-5 gap-3 justify-center rounded-md shadow-sm py-4 px-5 visible sm:hidden`}>
          {["All", "Active", "Completed"].map((text, i) =>
            theme === "light" ? (
              <button
                key={i}
